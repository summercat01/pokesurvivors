/**
 * English names for all 493 Pokemon (Gen 1-4), indexed by National Dex number.
 * Used by getPokemonName() in pokemonData.ts for i18n display.
 */
export const POKEMON_NAMES_EN: Record<number, string> = {
  // ===== Gen 1 (1~151) =====
