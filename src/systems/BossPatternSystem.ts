...
import { BossPatternBase } from './bossPatterns/BossPatternBase';
import type { BossPatternContext } from './bossPatterns/BossPatternBase';

export type { BossPatternContext };

export class BossPatternSystem extends BossPatternBase {
